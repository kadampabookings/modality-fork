...
final class AddNewPaymentExecutor {
    ...
    private static Future<Void> execute(Document document, Pane parentContainer) {
        ...
        PaymentService.initiatePayment(new InitiatePaymentArgument(amount, new PaymentAllocation[]{ new PaymentAllocation(document.getPrimaryKey(), amount)}, PaymentMethod.CARD, PaymentFormType.EMBEDDED,
