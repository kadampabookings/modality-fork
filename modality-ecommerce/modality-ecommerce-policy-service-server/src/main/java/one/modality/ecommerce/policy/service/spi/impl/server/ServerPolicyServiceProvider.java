...
public final class ServerPolicyServiceProvider implements PolicyServiceProvider {
    ...
    private static final String SCHEDULED_ITEMS_DQL_BASE =
            ...
            " select name,label,comment,site.name,item.(name,label,perResourceLabel,code,temporal,family.(code,name,label,ord),capacity,share_mate,ord),date,startTime,timeline?.(site,item,startTime,endTime),cancelled,resource,buddha.hyt" +
