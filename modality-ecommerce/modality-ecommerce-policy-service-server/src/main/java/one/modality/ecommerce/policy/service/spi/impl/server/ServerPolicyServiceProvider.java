    ...
    private Future<PolicyAggregate> loadPolicyForResolvedEventPk(Object resolvedEventPk, LoadPolicyArgument argument) {
        ...
        return QueryService.executeQueryBatch(
                new Batch<>(new QueryArgument[]{
                    ...
                    ",itemFamily.ord" +
                    ",applicableToInPerson,applicableToOnline,includedByDefault,dayVisitorDinnerAllowed" +
                    ...
                    ",applicableToInPerson,applicableToOnline,descriptionLabel,noticeLabel,minDay,default,genderInfoRequired,earlyAccommodationAllowed,lateAccommodationAllowed,minOccupancy,forceSoldOut,autoBookItem" +
