...
public record SubmitDocumentChangesResult(
    ...
    public static SubmitDocumentChangesResult createApprovedResult(Object documentPrimaryKey, Object documentRef, Object cartPrimaryKey, String cartUuid) {
        return new SubmitDocumentChangesResult(DocumentChangesStatus.APPROVED, null, documentPrimaryKey, documentRef, cartPrimaryKey, cartUuid, null, null, null, 0, null);
    }

    public static SubmitDocumentChangesResult createSoldOutResult(Object soldOutSitePrimaryKey, Object soldOutItemPrimaryKey) {
        return new SubmitDocumentChangesResult(DocumentChangesStatus.REJECTED, DocumentChangesRejectedReason.SOLD_OUT, null, null, null, null, soldOutSitePrimaryKey, soldOutItemPrimaryKey, null, 0, null);
    }

    public static SubmitDocumentChangesResult createAlreadyBookedResult() {
        return new SubmitDocumentChangesResult(DocumentChangesStatus.REJECTED, DocumentChangesRejectedReason.ALREADY_BOOKED, null, null, null, null, null, null, null, 0, null);
    }

    public static SubmitDocumentChangesResult createEventOnHoldResult() {
        return new SubmitDocumentChangesResult(DocumentChangesStatus.REJECTED, DocumentChangesRejectedReason.EVENT_ON_HOLD, null, null, null, null, null, null, null, 0, null);
    }

    public static SubmitDocumentChangesResult createEnqueuedResult(Object queueToken, int queueTotal) {
        return new SubmitDocumentChangesResult(DocumentChangesStatus.ENQUEUED, null, null, null, null, null, null, null, queueToken, queueTotal, null);
    }

    public static SubmitDocumentChangesResult withQueueToken(SubmitDocumentChangesResult result, Object queueToken) {
        return new SubmitDocumentChangesResult(result.status, result.rejectedReason, result.documentPrimaryKey, result.documentRef, result.cartPrimaryKey, result.cartUuid, result.soldOutSitePrimaryKey, result.soldOutItemPrimaryKey, queueToken, 0, null);
    }

    public static SubmitDocumentChangesResult technicalErrorResult(String errorMessage, Object queueToken) {
        return new SubmitDocumentChangesResult(DocumentChangesStatus.REJECTED, DocumentChangesRejectedReason.TECHNICAL_ERROR, null, null, null, null, null, null, queueToken, 0, errorMessage);
    }
